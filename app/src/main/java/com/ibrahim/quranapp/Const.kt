...
const val GET_SERVER_ARGS :String = "get the server args link form home fragment"
const val GET_SERVER_ARGS_POSITION :String = "get the server position form file fragment"